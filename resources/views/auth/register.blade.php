<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="Tipousuario" value="{{ __('Tipousuario') }}" />
                <x-jet-input id="Tipousuario" class="block mt-1 w-full" type="text" name="Tipousuario" :value="old('Tipousuario')" required  autocomplete="Tipousuario" />
            </div>
